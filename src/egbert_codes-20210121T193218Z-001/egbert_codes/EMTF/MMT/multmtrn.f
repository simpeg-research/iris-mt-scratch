...
c=========================================================================
     ...
     &   e_and_h,lBadRec,l_NoDeadChannels,l_noTFs
...
ccc...make directory for fourier coefficient files; open files
      write(0,*) 'cfilein(1,1)',cfilein(1,1)(1:20)
      call mkfdir(nsta_tot,ntape)
      if(.not.lfop) then
         call fop(nsta_tot,nch,ntape)
      end if
      write(0,*) 'done  making directory'
