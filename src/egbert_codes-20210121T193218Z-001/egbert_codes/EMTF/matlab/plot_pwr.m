ctitle = 'Hyy Power :: dB Above Average :: 30 Min. Averages :: PKD'
%  directories to use
...
for id = ids 
eval ( [ 'load /home/server/scratch/sierra/DATA/S_AVG/S_avg' num2str(id) '_90-119.mat' ] );
...
z1 = z1 ./z1;
z1(:,itime) = log10(z);
z1 = 10*(z1 - (zav * ones(1,itime(ntime))));
