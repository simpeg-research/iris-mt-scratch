...
y = y - height_n-vspace_n;
rect_plsm = [ x1,y,width2,height_n];
rect_perp = [x2,y,width2,height_n];
y = y - height_n-vspace_n;
rect_MTTF = [ x1,y,width2,height_n];
%rect_perp = [x2,y,width2,height_n];
y = y -(height_n+vspace_n);
...
ed1=uicontrol(gcf,'Style','edit',...
   ...
   'CallBack','n_evec=str2num(get(gcbo,''string''));');
...
ed2=uicontrol(gcf,'Style','edit',...
   ...
   'FontWeight','bold',...
   'Position',rect_rhor2,...
   'CallBack','rho_ref=str2num(get(gcbo,''string''));');
...
sc=uicontrol(gcf,'Style','radio',...
   ...
   'Value',snr_units,...
   'Position',rect_SNR,...
   'CallBack','snr_units=1-snr_units; set(gcbo,''Value'',snr_units);');
...
pe=uicontrol(gcf,'Style','radio',...
   ...
   'Value',l_ellipse,...
   'Position',rect_pol,...
   'CallBack','l_ellipse=1-l_ellipse; set(gcbo,''Value'',l_ellipse);');
