...
def set_driver_parameters():
    ...
    driver_parameters["runts_from_xml"] = True
...
def main():
    ...
    #<TEST RunTS FROM XML>
    if driver_parameters["runts_from_xml"]:
        ...
        runts_object = embed_metadata_into_run_ts("REW09",
                                                 xml_path=single_station_xml_template)
    #</TEST RunTS FROM XML>
