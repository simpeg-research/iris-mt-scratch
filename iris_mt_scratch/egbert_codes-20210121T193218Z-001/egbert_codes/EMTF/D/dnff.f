...
ccccEGBERT
      write(*,*) 'TIME_INTERVAL',time_int
      write(*,*) 'set_offset',iset_offset
...
ccc              print*, 'good',irec,lrec,id,ist
           else
...
c      l1 power spectrum  (only used when lpack = .true.)
      do 490 i = 1,nd
      do 490 j = 1,nch
      do 490 k = 1,nfuse(i)
         if(lpack) then
