...
ccc    compute julian day number for instrument clock zero (relative to
ccc    start of year for universal clock zero)
      jday = 0
      do i = iyru,iyr-1
...
ccc   compute julian day number for universal clock zero (relative to
ccc      start of year for universal clock zero)
      jdayu = 0
      do i = 1,imou-1
...
ccc   record number (relative to universal clock zero) of first record in file
      ...
      time_int = ((jday*24+ihr)*60+imin)
      time_int = time_int*60+isec
      sampfreq = 1./dr
