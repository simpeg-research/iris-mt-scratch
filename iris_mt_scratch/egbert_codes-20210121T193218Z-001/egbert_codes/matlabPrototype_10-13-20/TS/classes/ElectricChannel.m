classdef ElectricChannel < TChannelHeader
    % class for storing metadata for a single electric channel -- just adds
    % dipole length as a property
    %
